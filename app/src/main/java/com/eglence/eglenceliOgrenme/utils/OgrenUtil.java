...
public class OgrenUtil {
    ...
    public static void createOgrens(Context context){
        ...
        Ogren question1 = new Ogren(
                ...
                context.getResources().getInteger(R.integer.sayilar),
        ...
        Ogren question12 = new Ogren(
                ...
                context.getResources().getInteger(R.integer.hayvanlar),
        ...
        Ogren question32 = new Ogren(
                ...
                context.getResources().getInteger(R.integer.renkler),
        ...
        Ogren question43 = new Ogren(
                ...
                context.getResources().getInteger(R.integer.sekiller),
        ...
        Ogren question52 = new Ogren(
                ...
                context.getResources().getInteger(R.integer.harfler),
